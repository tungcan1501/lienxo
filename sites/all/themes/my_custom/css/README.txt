...
To use these stylesheets, rename the files and my_custom with the name of your theme.
...
my_custom-alpha-default-narrow.css  
...
my_custom-alpha-default-normal.css
...
my_custom-alpha-default-wide.css
